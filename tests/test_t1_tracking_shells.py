...
class TestDelayGeometry:
    ...
    def test_delay_mults_pinned_across_repos(self):
        ...
        from scqo_qm.probes.qubit_t1_ade import DELAY_MULTS as probe_mults
    ...
    def test_one_state_stream_per_delay(self):
        from scqo_qm.probes.qubit_t1_ade import DELAY_MULTS, _STATE_STREAMS
...
class TestShellToProbeMapping:
    ...
    def _capture(self, monkeypatch, probe_module_name):
        ...
        monkeypatch.setattr(
            f"scqo_qm.probes.{probe_module_name}.build_program",
            fake_build_program,
        )
        monkeypatch.setattr(
